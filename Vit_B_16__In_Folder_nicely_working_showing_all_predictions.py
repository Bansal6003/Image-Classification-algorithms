...
class ModelLoader:
    ...
    def load_model(self, model_path):
        ...
        # Adjust for the classifier layer
        ...
        num_classes = len(self.class_names)  # Use the number of classes from the input
...
class MainWindow(QMainWindow):
    ...
    def open_classification(self):
        class_names = ['Edema', 'Edema_TailCurl', 'Small Eyes', 'SmallEyes_Edema', 'TailCurl', 'Wild Type']  # Replace with actual class names
        model_path = r"D:\Behavioral genetics_V1\Metamorph_scans\WT_vs_nonWT_image_Classification\Dataset\MultiClass_Dataset_3dpf\Multiimage_dataset_V5\Vit_B_16_isolated_images_V1.pt"  # Replace with actual model path
