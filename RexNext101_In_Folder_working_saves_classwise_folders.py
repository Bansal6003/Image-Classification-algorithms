...
class ModelLoader:
    def __init__(self, model_path, class_names):
        # Load the ResNeXt-101 model with pre-trained weights
        self.model = torchvision.models.resnext101_32x8d(weights=torchvision.models.ResNeXt101_32X8D_Weights.IMAGENET1K_V1)
